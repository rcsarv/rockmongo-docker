...
*/
$MONGO["servers"][$i]["mongo_name"] = "mobile_db";//mongo server name
...
$MONGO["servers"][$i]["control_users"]["endbmongo"] = "endbmongopassDjsdd";//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false
